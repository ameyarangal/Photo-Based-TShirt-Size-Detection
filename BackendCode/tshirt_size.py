...
# Image resize code taken from https://stackoverflow.com/questions/44650888/resize-an-image-without-distortion-opencv?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
...
def get_size(filename):
    try:
        ...
        if tshirt is not None:
            ...
            return 'Error, Tshirt not detected!'
...
if __name__ == "__main__":
    debug = False
    print('Input Image size is {0}'.format(get_size("Size_L_predicted_L.jpg")))
